...
MorsMarkHighlighter::MorsMarkHighlighter(QTextDocument* parent)
    : QSyntaxHighlighter(parent) {
    updateOption();
}

void MorsMarkHighlighter::updateOption(void)
{
    format_.clear();
    regexp_.clear();
...
void MorsMarkHighlighter::_aux_multiBlockMatch(
        const QString&         text,
...
void MorsMarkHighlighter::highlightBlock(const QString& text)
{
